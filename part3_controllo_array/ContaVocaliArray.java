public class ContaVocaliArray {
    ...
    public static int contaA(String[] testo) {
        ...
        for (int i = 0; i < testo.length; i++){
            for (int k=0; k<testo[i].length(); k++) {
               if (testo[i].substring(k, k+1).equals("a")) contA++;
            }
        }
        return contA;
    }  
    ...
    public static int contaE(String[] testo) {
        ...
        for (int i = 0; i < testo.length; i++){
            for (int k=0; k<testo[i].length(); k++) {
               if (testo[i].substring(k, k+1).equals("e")) contE++;
            }
        }
        return contE;
    }  
    ...
    public static int contaI(String[] testo) {
        ...
        for (int i = 0; i < testo.length; i++){
            for (int k=0; k<testo[i].length(); k++) {
               if (testo[i].substring(k, k+1).equals("i")) contI++;
            }
        }
        return contI;
    }
    ...
    public static int contaO(String[] testo) {
        ...
        for (int i = 0; i < testo.length; i++){
            for (int k=0; k<testo[i].length(); k++) {
               if (testo[i].substring(k, k+1).equals("o")) contO++;
            }
        }
        return contO;
    }
    ...
    public static int contaU(String[] testo) {
        ...
        for (int i = 0; i < testo.length; i++){
            for (int k=0; k<testo[i].length(); k++) {
               if (testo[i].substring(k, k+1).equals("u")) contU++;
            }
        }
        return contU;
    }
